...
# Memory: tightly_coupled_data_memory
MEM_1 := sopc_config_lcd_tightly_coupled_data_memory
$(MEM_1)_NAME := tightly_coupled_data_memory
...
$(MEM_1)_HIERARCHICAL_PATH := tightly_coupled_data_memory
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: tightly_coupled_data_memory
tightly_coupled_data_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: tightly_coupled_instruction_memory
MEM_2 := sopc_config_lcd_tightly_coupled_instruction_memory
$(MEM_2)_NAME := tightly_coupled_instruction_memory
...
$(MEM_2)_START := 0x02002000
$(MEM_2)_END := 0x02002fff
$(MEM_2)_SPAN := 0x00001000
$(MEM_2)_HIERARCHICAL_PATH := tightly_coupled_instruction_memory
$(MEM_2)_WIDTH := 32
$(MEM_2)_HEX_DATA_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: tightly_coupled_instruction_memory
tightly_coupled_instruction_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
