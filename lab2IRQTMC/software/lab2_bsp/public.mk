...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../lab2_sopc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is lab2_sopc
SOPC_NAME := lab2_sopc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2001088
SOPC_SYSID_FLAG += --sidp=0x2001088
ELF_PATCH_FLAG  += --sidp 0x2001088

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1507117948
SOPC_SYSID_FLAG += --timestamp=1507117948
ELF_PATCH_FLAG  += --timestamp 1507117948
